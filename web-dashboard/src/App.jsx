  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(2rem, 8vw, 3.5rem)', margin: 0, background: 'linear-gradient(135deg, #f97316, #ec4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', lineHeight: 1.2 }}>
          CommunityConnect
        </h1>
      </motion.div>
      <motion.p
